...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:Mahirane231995@localhost/Marvel3?charset=utf8mb4'
...
def create_database():
    root_engine = create_engine("mysql+mysqlconnector://root:Mahirane231995@localhost")  # No database specified
    with root_engine.connect() as connection:
        connection.execute(text("CREATE DATABASE IF NOT EXISTS Marvel3"))
